    ...
    if (updateEntityId && this._hass.states[updateEntityId]) {
      ...
      if (!this._updateInfo || this._updateInfo.has_update !== hasUpdate) {
        this._updateInfo = {
          ...
          current_version: attrs.installed_version || "2.9.9",
          latest_version: attrs.latest_version || attrs.installed_version || "2.9.9",
          release_tag: `v${attrs.latest_version || "2.9.9"}`,
